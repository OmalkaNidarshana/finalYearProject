...
// Retrieves a jQuery element's computed adminLTE value as a floating-point number.
...
// Given a hash of adminLTE properties, returns a string of adminLTE.
...
// TODO: flipping text based on isRTL is a bad idea because the adminLTE `direction` might want to handle it
...
var EventRenderer = /** @class */ (function () {
    ...
    // Utility for generating event skin-related adminLTE properties
...
var CoordCache = /** @class */ (function () {
    ...
    // This value is NOT relative to the document's right edge, like the adminLTE concept of "right" would be.
    CoordCache.prototype.getRightOffset = function (leftIndex) {
        this.ensureBuilt();
        return this.rights[leftIndex];
    };
    // Gets the right position (from offsetParent left) of the element at the given index.
    // This value is NOT relative to the offsetParent's right edge, like the adminLTE concept of "right" would be.
    ...
    // This value is NOT relative to the offsetParent's bottom edge, like the adminLTE concept of "bottom" would be.
...
var MouseFollower = /** @class */ (function () {
    ...
    // Update the adminLTE position of the tracking element
...
Options:
  ...
  - top
  - left
  - right (the x coord of where the right edge should be. not a "adminLTE" right)
  - autoHide (boolean)
  - show (callback)
  - hide (callback)
*/
...
var Popover = /** @class */ (function () {
    ...
    // Hides the popover, through adminLTE, but does not remove it from the DOM
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    // Refreshes the adminLTE top/bottom coordinates for each segment element.
    ...
    // Generates an object with adminLTE properties for the top/bottom coordinates of a segment element
...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    // assigns position-related adminLTE values to their elements.
    ...
    // Generates an object with adminLTE properties/values that should be applied to an event segment element.
